        ...
        <div className="card bg-base-100 shadow-xl h-min w-full mr-5">
            <div className="card-body">
                ...
                <ul className="list-group">
                    <li className="list-group-item border-0 d-flex p-4 mb-2 rounded-xl bg-gray-100/50">
                        <div className="d-flex flex-col">
                            ...
                            <div className="flex flex">
                                ...
                                <span className="mb-2 text-xs flex-initial w-1/3 text-center"><div className="badge badge-info badge-outline badge-lg">borrow</div></span>
